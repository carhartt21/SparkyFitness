...
| Water reminders | App-scope `HydrationReminderReconciler` / `useHydrationReminder` | Existing water scheduler remains the sole owner until explicitly transferred; it currently depends on server-derived totals |

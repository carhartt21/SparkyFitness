...
export const SafeExerciseReview = withErrorBoundary(ExerciseReviewScreen, 'ExerciseReview', { canGoBack: true });
...
export const SafeMovementBreak = withErrorBoundary(MovementBreakScreen, 'MovementBreak', { canGoBack: true });
export const SafeGuidedMobility = withErrorBoundary(GuidedMobilityScreen, 'GuidedMobility', { canGoBack: true });

  ...
  return (
    <Pressable
      ...
      accessibilityLabel={t(
        'notificationSettings.permissionWarningAccessibility',
        {
    ...
    >
      ...
      <View className="flex-1 ml-3">
        ...
        <Text className="text-text-primary text-sm mt-1 opacity-80">
          {body}
        </Text>
        <Text className="text-sm font-semibold text-accent-primary self-end mt-2">
          {actionLabel}
        </Text>
      </View>
    </Pressable>

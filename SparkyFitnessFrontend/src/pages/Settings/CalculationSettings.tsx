          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="adaptive-goal" className="cursor-pointer">
              ...
              {t(
                ...
                "The 'Gold Standard'. X on Track calculates your TDEE by correlating your actual weight changes with your calorie intake over the last 35 days. It 'learns' your unique metabolism."
              )}
            </Label>
          </div>
          <div className="flex items-center space-x-2">
                  ...
                  <p className="mt-2 text-sm opacity-80 border-t border-current/20 pt-2 flex items-start gap-1">
                    ...
                    <span>
                      {t('settings.goalMode.estimatedTargetNote', {
                        defaultValue:
                          'Note: This target is currently based on an estimated activity level. After {{required}}+ days of weight and calorie data, X on Track will calculate a more personalized adaptive TDEE.',

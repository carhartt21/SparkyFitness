...
Migrations, in order: `20260923000000_add_food_entry_client_operation_id.sql`, `20260923010000_allow_offline_food_snapshots.sql`, `20260923020000_add_nutrition_captures.sql`, and `20260923030000_link_food_entries_to_nutrition_captures.sql`. Apply to a disposable copy of the previous stable database before production rollout; a live PostgreSQL migration test has not run in this workspace.
...
- Full validation passed for server and mobile. Server tests: 399 files passed, 7 skipped; 4,862 tests passed, 305 skipped. Mobile tests: 447 suites and 7,000 tests passed. The iOS prebuild generated targets, but the simulator build requires CocoaPods; no physical device acceptance test has run.
